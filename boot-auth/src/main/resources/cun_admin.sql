...
CREATE TABLE `sys_biz_tenant`  (
  `id` int(0) NOT NULL AUTO_INCREMENT COMMENT '内部id',
  ...
  `qps` int(0) NOT NULL COMMENT 'qps，默认0（无限制）',
  `day_limit` int(0) NOT NULL COMMENT '日请求上限，默认0（无限制）',
...
CREATE TABLE `sys_menu`  (
  `id` int(0) NOT NULL AUTO_INCREMENT COMMENT 'menu id',
  ...
  `p_id` int(0) NOT NULL DEFAULT 0 COMMENT '父类id，默认0（第一级）',
  `t_id` int(0) NOT NULL DEFAULT 0 COMMENT '顶部id，默认0',
  `type` int(0) NOT NULL DEFAULT 1 COMMENT '1：菜单，2：按钮',
  `m_type` int(0) NOT NULL DEFAULT 1 COMMENT '1：左侧菜单，2：顶部菜单',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 29 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '系统-菜单' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_role` VALUES (2, '测试', '测试手术', 1, 0, 'admin', '2020-05-26 13:50:44', '2020-12-15 21:15:13');
...
CREATE TABLE `sys_role_menu`  (
  `role_id` int(0) NOT NULL COMMENT 'sys role id',
  `menu_id` int(0) NOT NULL COMMENT 'sys menu id',
...
CREATE TABLE `sys_user`  (
  `id` int(0) NOT NULL AUTO_INCREMENT COMMENT '主键，内部id',
...
CREATE TABLE `sys_user_role`  (
  `user_id` int(0) NOT NULL COMMENT 'sys user id',
  `role_id` int(0) NOT NULL COMMENT 'sys role id',
...
-- Records of test
-- ----------------------------
INSERT INTO `test` VALUES (1, 1, 1, 1, 1, NULL);
