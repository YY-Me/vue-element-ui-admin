...
-- ----------------------------
-- Table structure for enterprise_menu
-- ----------------------------
DROP TABLE IF EXISTS `enterprise_menu`;
...
) ENGINE = InnoDB AUTO_INCREMENT = 16 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '系统-菜单' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of enterprise_menu
-- ----------------------------
INSERT INTO `enterprise_menu` VALUES (1, '首页', NULL, 'index', 0, 12, 1, 1, '/index', 'dashboard', 1);
INSERT INTO `enterprise_menu` VALUES (2, '控制台', 'dashboard', 'dashboard', 1, 0, 1, 1, 'console', 'dashboard', 0);
INSERT INTO `enterprise_menu` VALUES (3, '系统用户', NULL, 'sys:user:index', 0, 11, 1, 1, '/system', 'system-user', 3);
INSERT INTO `enterprise_menu` VALUES (4, '用户管理', 'systemUser', 'sys:user:list', 3, 0, 1, 1, 'user', 'system-user', 0);
INSERT INTO `enterprise_menu` VALUES (5, '权限中心', NULL, 'sys:permission:index', 0, 11, 1, 1, '/permission', 'permission', 4);
INSERT INTO `enterprise_menu` VALUES (6, '角色管理', 'systemRole', 'sys:role', 5, 0, 1, 1, 'role', 'role', 0);
INSERT INTO `enterprise_menu` VALUES (7, '菜单管理', 'systemMenu', 'sys:menu', 5, 0, 1, 1, 'menu', 'menu', 0);
INSERT INTO `enterprise_menu` VALUES (8, '租户管理', NULL, 'sys:tenant:index', 0, 12, 1, 1, '/tenant', 'tenant', 2);
INSERT INTO `enterprise_menu` VALUES (9, '租户管理', 'tenant', 'sys:tenant:list', 8, 0, 1, 1, 'tenant', 'tenant', 0);
INSERT INTO `enterprise_menu` VALUES (11, '系统配置', NULL, 'top:user:center', 0, 0, 1, 2, '/top2', 'system-config', 2);
INSERT INTO `enterprise_menu` VALUES (12, '业务系统', NULL, 'top:biz:center', 0, 0, 1, 2, '/top1', 'biz', 1);
INSERT INTO `enterprise_menu` VALUES (14, '顶部菜单', '', 'top:test:1', 0, 0, 1, 2, '/top3', 'el-icon-s-flag', 3);
INSERT INTO `enterprise_menu` VALUES (15, '测试1', 'test1', 'top:test:1:1', 14, 0, 1, 2, 'test1', 'el-icon-s-data', 1);
INSERT INTO `enterprise_menu` VALUES (16, '测试2', 'test2', 'top:test:1:2', 14, 0, 1, 2, 'test2', 'el-icon-s-comment', 2);
...
-- ----------------------------
INSERT INTO `enterprise_role` VALUES (1, '顶级管理员', '谨慎！，一不注意就把自己玩死', 1, 1, 'admin', '2020-05-18 16:00:39', '2020-05-18 16:07:10');
INSERT INTO `enterprise_role` VALUES (2, '测试', '测试手术', 1, 0, 'admin', '2020-05-26 13:50:44', '2020-05-27 09:43:09');

-- ----------------------------
-- Table structure for enterprise_role_menu
-- ----------------------------
DROP TABLE IF EXISTS `enterprise_role_menu`;
CREATE TABLE `enterprise_role_menu`  (
...
-- ----------------------------
-- Records of enterprise_role_menu
-- ----------------------------
INSERT INTO `enterprise_role_menu` VALUES (1, 1);
INSERT INTO `enterprise_role_menu` VALUES (1, 2);
INSERT INTO `enterprise_role_menu` VALUES (1, 3);
INSERT INTO `enterprise_role_menu` VALUES (1, 4);
INSERT INTO `enterprise_role_menu` VALUES (1, 5);
INSERT INTO `enterprise_role_menu` VALUES (1, 6);
INSERT INTO `enterprise_role_menu` VALUES (1, 7);
INSERT INTO `enterprise_role_menu` VALUES (1, 8);
INSERT INTO `enterprise_role_menu` VALUES (1, 9);
INSERT INTO `enterprise_role_menu` VALUES (1, 11);
INSERT INTO `enterprise_role_menu` VALUES (1, 12);
INSERT INTO `enterprise_role_menu` VALUES (1, 14);
INSERT INTO `enterprise_role_menu` VALUES (1, 15);
INSERT INTO `enterprise_role_menu` VALUES (1, 16);
...
-- ----------------------------
INSERT INTO `enterprise_user_role` VALUES (1, 1);
INSERT INTO `enterprise_user_role` VALUES (2, 2);
...
INSERT INTO `sys_menu` VALUES (14, '顶部菜单', '', 'top:test:1', 0, 0, 1, 2, '/top3', 'el-icon-s-flag', 3);
INSERT INTO `sys_menu` VALUES (15, '测试1', 'test1', 'top:test:1:1', 14, 0, 1, 2, 'test1', 'el-icon-s-data', 1);
INSERT INTO `sys_menu` VALUES (16, '测试2', 'test2', 'top:test:1:2', 14, 0, 1, 2, 'test2', 'el-icon-s-comment', 2);
