...
! function(s) {
    ...
    function m(e) {
        return function(t) {
            return function(t) {
                ...
                var e = typeof t;
                return "object" == e && (Array.prototype.isPrototypeOf(t) || t.constructor && "Array" === t.constructor.name) ?
                    "array" : "object" == e && (String.prototype.isPrototypeOf(t) || t.constructor && "String" === t.constructor.name) ?
                        "string" : e
            }(t) === e
        }
    }
    ...
    var p, g, h, v, b = function(n) {
        ...
        I = (E(Array.from) && Array.from, function() {
    ...
    p = undefined, g = x, h = C, v = undefined,
        function(t) {
            "object" == typeof g && void 0 !== h ? h.exports = t() : "function" == typeof p && p.amd ? p([], t) : ("undefined" !=
            typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : this).EphoxContactWrapper =
                t()
        }(function() {
            return function s(o, a, u) {
                ...
                for (var l = "function" == typeof v && v, t = 0; t < u.length; t++) c(u[t]);
                return c
            }({
                1: [function(t, e, n) {
                    var r, i, o = e.exports = {};
                    ...
                    }, o.title = "browser", o.browser = !0, o.env = {}, o.argv = [], o.version = "", o.versions = {}, o.on = h,
                        o.addListener = h, o.once = h, o.off = h, o.removeListener = h, o.removeAllListeners = h, o.emit = h, o.prependListener =
                        h, o.prependOnceListener = h, o.listeners = function(t) {
                        return []
    ...
    function L(t, e, n) {
        ! function(t, e, n) {
            if (!(_(n) || A(n) || N(n))) throw s.console.error("Invalid call to Attr.set. Key ", e, ":: Value ", n,
                ":: Element ", t), new Error("Attribute value was not simple");
            t.setAttribute(e, n + "")
        }(t.dom(), e, n)
    }
    ...
    function j(t) {
        return t.style.marginLeft && t.style.marginRight && t.style.marginLeft === t.style.marginRight ? Pt(t.style.marginLeft) :
            ""
    }

    function F(t) {
        return t.style.marginTop && t.style.marginBottom && t.style.marginTop === t.style.marginBottom ? Pt(t.style.marginTop) :
            ""
    }
    ...
    function G(t) {
        z(t) ? function(t) {
            ...
            var e = Ht.create("figure", {
                "class": "image"
            });
            Ht.insertAfter(e, t), e.appendChild(t), e.appendChild(Ht.create("figcaption", {
    ...
    function Z(t) {
        return 0 === Ht.getAttrib(t, "alt").length && "presentation" === Ht.getAttrib(t, "role")
    }

    function Q(t, e) {
        var n = s.document.createElement("img");
        return B(n, "style", e.style), !j(n) && "" === e.hspace || X(n, e.hspace), !F(n) && "" === e.vspace || $(n, e.vspace),
        !M(n) && "" === e.border || J(n, e.border), ! function(t) {
            return H(t, "borderStyle")
        }(n) && "" === e.borderStyle || Y(n, e.borderStyle), t(n.getAttribute("style"))
    }
    ...
    function at(e, t, n) {
        var r = function(t, e, n) {
            ...
            if (Bt(t, I(I({}, e), {
                caption: !1
            }), r, n), zt(r, e.alt, e.isDecorative, n), e.caption) {
                var i = Ht.create("figure", {
                    "class": "image"
                });
                return i.appendChild(r), i.appendChild(Ht.create("figcaption", {
                    contentEditable: "true"
                }, "Caption")), i.contentEditable = "false", i
            }
            return r
        }(function(t) {
            return rt(e, t)
        }, t, n);
        e.dom.setAttrib(r, "data-mce-id", "__mcenew"), e.focus(), e.selection.setContent(r.outerHTML);
    ...
    var st, ft = C.exports.boltExport,
        dt = function(t) {
            var n = w.none(),
                e = [],
                r = function(t) {
        ...
        At = (s.Node.ATTRIBUTE_NODE, s.Node.CDATA_SECTION_NODE, s.Node.COMMENT_NODE, s.Node.DOCUMENT_NODE, s.Node.DOCUMENT_TYPE_NODE,
            s.Node.DOCUMENT_FRAGMENT_NODE, s.Node.ELEMENT_NODE, s.Node.TEXT_NODE, s.Node.PROCESSING_INSTRUCTION_NODE, s.Node.ENTITY_REFERENCE_NODE,
            s.Node.ENTITY_NODE, s.Node.NOTATION_NODE, "undefined" != typeof s.window ? s.window : Function("return this;")(),
            function(t) {
        ...
        Et = {
            fromHtml: function(t, e) {
                ...
                if (n.innerHTML = t, !n.hasChildNodes() || 1 < n.childNodes.length) throw s.console.error(
                    "HTML does not have a single root node", t), new Error("HTML must have a single root node");
        ...
        St = function(t, e) {
            ...
            var i = r.style;
            i.visibility = "hidden", i.position = "fixed", i.bottom = i.left = "0px", i.width = i.height = "auto", s.document.body
                .appendChild(r), r.src = t
        },
        Pt = function(t) {
        ...
        Rt = function(t) {
            if (t.margin) {
                ...
                switch (e.length) {
                    case 1:
                        t["margin-top"] = t["margin-top"] || e[0], t["margin-right"] = t["margin-right"] || e[0], t["margin-bottom"] = t[
                            "margin-bottom"] || e[0], t["margin-left"] = t["margin-left"] || e[0];
                        break;
                    case 2:
                        t["margin-top"] = t["margin-top"] || e[0], t["margin-right"] = t["margin-right"] || e[1], t["margin-bottom"] = t[
                            "margin-bottom"] || e[0], t["margin-left"] = t["margin-left"] || e[1];
                        break;
                    case 3:
                        t["margin-top"] = t["margin-top"] || e[0], t["margin-right"] = t["margin-right"] || e[1], t["margin-bottom"] = t[
                            "margin-bottom"] || e[2], t["margin-left"] = t["margin-left"] || e[1];
                        break;
                    case 4:
                        t["margin-top"] = t["margin-top"] || e[0], t["margin-right"] = t["margin-right"] || e[1], t["margin-bottom"] = t[
                            "margin-bottom"] || e[2], t["margin-left"] = t["margin-left"] || e[3]
                }
                delete t.margin
            }
            return t
        ...
        zt = function(t, e, n, r) {
            if (n) {
                ...
                "presentation" === Ht.getAttrib(t, "role") && Ht.setAttrib(t, "role", "")
            }
        },
        Bt = function(t, e, n, r) {
            var i = tt(t, n);
            et(n, i, e, "caption", function(t, e, n) {
                return G(t)
            }), et(n, i, e, "src", B), et(n, i, e, "title", B), et(n, i, e, "width", q(0, t)), et(n, i, e, "height", q(0, t)),
                et(n, i, e, "class", B), et(n, i, e, "style", nt(function(t, e) {
                return B(t, "style", e)
            }, t)), et(n, i, e, "hspace", nt(X, t)), et(n, i, e, "vspace", nt($, t)), et(n, i, e, "border", nt(J, t)), et(n, i,
                e, "borderStyle", nt(Y, t)),
                function(t, e, n, r) {
                    n.alt === e.alt && n.isDecorative === e.isDecorative || zt(t, n.alt, n.isDecorative, r)
                }(n, i, e, r)
        },
        Gt = tinymce.util.Tools.resolve("tinymce.util.Tools"),
        Wt = function(t, i) {
            var o = [];
            return Gt.each(t, function(t) {
        ...
        qt = function(t, e) {
            return function(t, e) {
                ...
                }(t) ? qt(t.items, e) : t.value === e ? w.some(t) : w.none()
            })
        },
        Vt = lt,
        Xt = function(t) {
    ...
    function Jt(a) {
        function e(t, e, n, r) {
            ...
            (i = new s.XMLHttpRequest).open("POST", a.url), i.withCredentials = a.credentials, i.upload.onprogress = function(t) {
                ...
                var t;
                i.status < 200 || 300 <= i.status ? n("HTTP Error: " + i.status) : (t = JSON.parse(i.responseText)) && "string" ==
                typeof t.location ? e(function(t, e) {
        ...
        return a = Gt.extend({
            ...
            upload: function(t) {
                return !a.url && function(t) {
                    return t === e
                }(a.handler) ? Ot.reject("Upload url missing from the settings.") : function(r, i) {
                    return new Ot(function(t, e) {
                        try {
                            i(r, t, e, o)
                        } catch (n) {
    ...
    function Kt(t) {
        ...
        return T([
            [{
                ...
                filetype: "image",
                label: "Source"
            }], e.toArray(), t.hasAccessibilityOptions && t.hasDescription ? [{
                type: "label",
                label: "Accessibility",
                items: [{
                    name: "isDecorative",
            ...
            }] : [], t.hasDescription ? [n] : [], t.hasImageTitle ? [{
                name: "title",
                type: "input",
                label: "Image title"
            }] : [], t.hasDimensions ? [{
            ...
            [{
                type: "grid",
                columns: 2,
                items: T([r.toArray(), t.hasImageCaption ? [{
                    type: "label",
                    label: "Caption",
                    items: [{
                        type: "checkbox",
    ...
    function ee(t, e) {
        ...
        if (r !== undefined) {
            var i = Dt({}, n);
            ! function(t, e, n) {
                t.hasDescription && _(n.alt) && (e.alt = n.alt), t.hasAccessibilityOptions && (e.isDecorative = n.isDecorative || e
                    .isDecorative || !1), t.hasImageTitle && _(n.title) && (e.title = n.title), t.hasDimensions && (_(n.width) && (e.dimensions
                    .width = n.width), _(n.height) && (e.dimensions.height = n.height)), _(n["class"]) && $t(t.classList, n["class"])
                    .each(function(t) {
                        e.classes = t.value
                    }), t.hasImageCaption && A(n.caption) && (e.caption = n.caption), t.hasAdvTab && (_(n.style) && (e.style = n.style),
                _(n.vspace) && (e.vspace = n.vspace), _(n.border) && (e.border = n.border), _(n.hspace) && (e.hspace = n.hspace),
    ...
    function re(t, e, n) {
        ...
        return i.vspace = function(t) {
            return t["margin-top"] && t["margin-bottom"] && t["margin-top"] === t["margin-bottom"] ? Pt(String(t["margin-top"])) :
                ""
        }(r), i.hspace = function(t) {
            return t["margin-right"] && t["margin-left"] && t["margin-right"] === t["margin-left"] ? Pt(String(t["margin-right"])) :
                ""
        ...
        l.block("Uploading image"),
            function(t) {
                ...
                Mt(n).then(function(t) {
                    ...
                    c.automaticUploads ? a.upload(e).then(function(t) {
                        i(t), r()
                    })["catch"](function(t) {
                        r(), u.alertErr(l, t)
    ...
    function oe(n, r, i) {
        return function(t, e) {
            "src" === e.name ? ne(n, r, i, t) : "images" === e.name ? function(t, e, n, r) {
                var i = r.getData(),
            ...
            }(n, r, t) : "fileinput" === e.name ? ie(n, r, i, t) : "isDecorative" === e.name && (t.getData().isDecorative ? t.disable(
                "alt") : t.enable("alt"))
        }
    }
            ...
            return {
                ...
                body: function(t) {
                    return t.hasAdvTab || t.hasUploadUrl || t.hasUploadHandler ? {
                        type: "tabpanel",
                        tabs: T([
                            [se(t)], t.hasAdvTab ? [le(t)] : [], t.hasUploadTab && (t.hasUploadUrl || t.hasUploadHandler) ? [de(t)] : []
                        ])
                    } : {
                        type: "panel",
                        items: fe(t)
    ...
    function ue(e) {
        ...
        return {
            open: function() {
                return Yt(e).map(ae(t)).get(function(t) {
    ...
    function ce(o) {
        return function(t) {
            for (var e, n = t.length, r = function(t) {
                ...
                var i = t[n];
                void 0, (e = i.attr("class")) && /\bimage\b/.test(e) && (i.attr("contenteditable", o ? "false" : null), Gt.each(i.getAll(
                    "figcaption"), r))
            }
        }
    }
    var le = function(t) {
        ...
        pe = function(t) {
            t.on("PreInit", function() {
                t.parser.addNodeFilter("figure", ce(!0)), t.serializer.addNodeFilter("figure", ce(!1))
            })
        },
        ge = function(e) {
            e.ui.registry.addToggleButton("image", {
                ...
                onAction: ue(e).open,
                onSetup: function(t) {
                    return e.selection.selectorChangedWithUnbind("img:not([data-mce-object],[data-mce-placeholder]),figure.image",
                        t.setActive).unbind
                }
